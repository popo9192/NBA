...
def buildModel(df):
    ...
    #
    df =df[['avg_FG3A_x','avg_FG3%_x','avg_PCT_FGA_3PT_x','avg_PCT_PTS_3PT_x','avg_PCT_AST_3PM_x','avg_PCT_UAST_3PM_x','vs_avg_FG3A_y','vs_avg_FG3%_y',
    'vs_avg_PCT_FGA_3PT_y','vs_avg_PCT_PTS_3PT_y','vs_avg_PCT_AST_3PM_y','vs_avg_PCT_UAST_3PM_y']]

# ----------------------FOR HOME AWAY SPLIT--------------------------------------
    dfh =dfh[['avg_FG3A_x','avg_FG3%_x','avg_PCT_FGA_3PT_x','avg_PCT_PTS_3PT_x','avg_PCT_AST_3PM_x','avg_PCT_UAST_3PM_x','vs_avg_FG3A_y','vs_avg_FG3%_y',
    'vs_avg_PCT_FGA_3PT_y','vs_avg_PCT_PTS_3PT_y','vs_avg_PCT_AST_3PM_y','vs_avg_PCT_UAST_3PM_y']]
    dfa =dfa[['avg_FG3A_x','avg_FG3%_x','avg_PCT_FGA_3PT_x','avg_PCT_PTS_3PT_x','avg_PCT_AST_3PM_x','avg_PCT_UAST_3PM_x','vs_avg_FG3A_y','vs_avg_FG3%_y',
    'vs_avg_PCT_FGA_3PT_y','vs_avg_PCT_PTS_3PT_y','vs_avg_PCT_AST_3PM_y','vs_avg_PCT_UAST_3PM_y']]
...
def Regression(df):
    ...
    #
    # paceModelFile = 'Backtest_Pace_Model.sav'
    # pickle.dump(regressor_p,open(paceModelFile,'wb'))
    #
    # FFModelFile = 'Backtest_FF_Model.sav'
    # pickle.dump(regressor_2,open(FFModelFile,'wb'))
...
def RunModels(df,odds):
    ...
    df = pd.DataFrame({'GAMECODE_x':dfy['GAMECODE'],'TEAM_ABBREVIATION_x_x':dfy['TEAM_ABBREVIATION_x_x'],'Predicted':threePred})
    df3 = pd.merge(df, odds, on=['GAMECODE_x','TEAM_ABBREVIATION_x_x'],how='left')
